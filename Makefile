...
# DEMOS bounce gravity pacman nbodies damping spaceinvaders pegs
DEMOS = game
# List of C files in "libraries" that we provide
STAFF_LIBS = test_util sdl_wrapper
# List of C files in "libraries" that you will write
STUDENT_LIBS = vector list polygon \
	body scene \
	collision forces
...
#TEST_BINS = $(addprefix bin/test_suite_, body forces scene vector collision) bin/student_tests
