 ...
 * @param aux an auxiliary value that can store parameters or values
 */
typedef void (*KeyHandler)(
    char key, KeyEventType type, double held_time, void *aux
);
 ...
 * Renders text
 *
 * @param texture pointer to SDL_Texture * to be rendered
 * @param rect pointer to SDL_Rect to be render
